          ...
          <div className="mb-8 bg-[#161B22] border border-gray-800 rounded-xl p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400 text-xs">Android 8.0+ | v1.4 | Funciona no celular e BlueStacks</p>
              </div>
              <a
                href="https://github.com/Meytsu/macroforge-site/releases/download/v1.4/app-release.apk"
